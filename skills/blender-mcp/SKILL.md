---
name: blender-mcp
description: "Control Blender directly from agent runtime via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender."
---
...
Control Blender directly from agent runtime via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.

## Use When

- The user request matches `blender-mcp`, `blender mcp`, `creative` or the skill description.
- Control Blender directly from agent runtime via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.
