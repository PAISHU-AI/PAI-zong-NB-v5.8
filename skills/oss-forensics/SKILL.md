---
name: oss-forensics
description: "Codex-adapted oss forensics workflow for security tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability."
---
...
Codex-adapted oss forensics workflow for security tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.

## Use When

- The user request matches `oss-forensics`, `oss forensics`, `security` or the skill description.
- Codex-adapted oss forensics workflow for security tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.
