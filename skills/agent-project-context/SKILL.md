...
description: "Use when modifying or analyzing a repository in agent runtime. Inspect the project root, local rules, manifests, commands, and nearby patterns before editing files or making repo-level claims."
---
...
Use when modifying or analyzing a repository in agent runtime. Inspect the project root, local rules, manifests, commands, and nearby patterns before editing files or making repo-level claims.

## Use When

- The user request matches `agent-project-context`, `agent project context`, `software-development` or the skill description.
- Use when modifying or analyzing a repository in agent runtime. Inspect the project root, local rules, manifests, commands, and nearby patterns before editing files or making repo-level claims.
