...
description: "Codex-adapted memento flashcards workflow for productivity tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability."
---
...
Codex-adapted memento flashcards workflow for productivity tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.

## Use When

- The user request matches `memento-flashcards`, `memento flashcards`, `productivity` or the skill description.
- Codex-adapted memento flashcards workflow for productivity tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.
