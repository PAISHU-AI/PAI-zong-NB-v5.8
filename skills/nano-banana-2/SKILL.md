---
name: nano-banana-2
description: "Codex-adapted nano banana 2 workflow for creative tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability."
---
...
Codex-adapted nano banana 2 workflow for creative tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.

## Use When

- The user request matches `nano-banana-2`, `nano banana 2`, `creative` or the skill description.
- Codex-adapted nano banana 2 workflow for creative tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.
