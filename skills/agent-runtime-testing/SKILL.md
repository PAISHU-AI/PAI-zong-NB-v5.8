---
name: agent-runtime-testing
description: "Use when creating, repairing, or evaluating tests in agent-runtime repository work."
---
...
Use when creating, repairing, or evaluating tests in agent-runtime repository work.

## Use When

- The user request matches `agent-runtime-testing`, `agent runtime testing`, `software-development` or the skill description.
- Use when creating, repairing, or evaluating tests in agent-runtime repository work.
