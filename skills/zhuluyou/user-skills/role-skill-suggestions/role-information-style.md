...
| Owner | Rule Governor |
| Generated | Yes |
| Role File | `role-information-style.md` |
...
|---|---|---|---|---|
| `information-research` | `information-research` | Research, source synthesis, paper/repo/article analysis, local knowledge search, and evidence-backed summaries. | default-first | `information-research`, `darwinian-evolver`, `domain-intel`, `duckduckgo-search`, `find-nearby`, `gitnexus-explorer`, `osint-investigation`, `parallel-cli` |
...
| `health-bio-research` | `bioinformatics` | Bioinformatics, drug discovery, health, nutrition, neuroscience, and biomedical research workflows. | gated-default | `bioinformatics`, `drug-discovery`, `fitness-nutrition`, `neuroskill-bci` |
