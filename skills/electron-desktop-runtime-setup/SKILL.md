---
name: electron-desktop-runtime-setup
description: "Set up, pin, and verify Node/Electron desktop app development runtimes, especially projects with native dependencies, Electron rebuilds, npm install behavior, and test environment differences. Use when initializing or modifying Electron apps, changing Node versions, diagnosing install/test failures caused by runtime mismatch, or preparing a stable second-development environment."
---
...
Set up, pin, and verify Node/Electron desktop app development runtimes, especially projects with native dependencies, Electron rebuilds, npm install behavior, and test environment differences. Use when initializing or modifying Electron apps, changing Node versions, diagnosing install/test failures caused by runtime mismatch, or preparing a stable second-development environment.

## Use When

- The user request matches `electron-desktop-runtime-setup`, `electron desktop runtime setup`, `software-development` or the skill description.
- Set up, pin, and verify Node/Electron desktop app development runtimes, especially projects with native dependencies, Electron rebuilds, npm install behavior, and test environment differences. Use when initializing or modifying Electron apps, changing Node versions, diagnosing install/test failures caused by runtime mismatch, or preparing a stable second-development environment.
