---
name: drug-discovery
description: "Codex-adapted drug discovery workflow for research tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability."
---
...
Codex-adapted drug discovery workflow for research tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.

## Use When

- The user request matches `drug-discovery`, `drug discovery`, `research` or the skill description.
- Codex-adapted drug discovery workflow for research tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.
