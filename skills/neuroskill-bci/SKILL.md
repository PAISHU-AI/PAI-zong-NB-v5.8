---
name: neuroskill-bci
description: "Codex-adapted neuroskill bci workflow for health tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability."
---
...
Codex-adapted neuroskill bci workflow for health tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.

## Use When

- The user request matches `neuroskill-bci`, `neuroskill bci`, `health` or the skill description.
- Codex-adapted neuroskill bci workflow for health tasks. Use when the user request clearly matches this domain and a compact procedural guide improves reliability.
