---
name: agent-router-lite
description: "Use when a task needs lightweight routing in agent runtime: classify the task, choose the smallest effective execution path, and decide whether to load zero, one, or a few additional skills."
---
...
Use when a task needs lightweight routing in agent runtime: classify the task, choose the smallest effective execution path, and decide whether to load zero, one, or a few additional skills.

## Use When

- The user request matches `agent-router-lite`, `agent router lite`, `software-development` or the skill description.
- Use when a task needs lightweight routing in agent runtime: classify the task, choose the smallest effective execution path, and decide whether to load zero, one, or a few additional skills.
