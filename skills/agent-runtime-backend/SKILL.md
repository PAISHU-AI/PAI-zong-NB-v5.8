...
description: "Use when implementing backend services, business logic, handlers, jobs, integrations, and server-side fixes in agent-runtime repository work."
---
...
Use when implementing backend services, business logic, handlers, jobs, integrations, and server-side fixes in agent-runtime repository work.

## Use When

- The user request matches `agent-runtime-backend`, `agent runtime backend`, `software-development` or the skill description.
- Use when implementing backend services, business logic, handlers, jobs, integrations, and server-side fixes in agent-runtime repository work.
