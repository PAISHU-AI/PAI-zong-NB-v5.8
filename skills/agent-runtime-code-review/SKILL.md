---
name: agent-runtime-code-review
description: "Use when reviewing diffs, pull requests, or risky code changes in agent-runtime repository work."
---

# agent-runtime-code-review

## Purpose

Use when reviewing diffs, pull requests, or risky code changes in agent-runtime repository work.

## Use When

- The user request matches `agent-runtime-code-review`, `agent runtime code review`, `software-development` or the skill description.
- Use when reviewing diffs, pull requests, or risky code changes in agent-runtime repository work.
