...
description: "Use after meaningful code or config changes in agent runtime to run the smallest relevant verification set and report grounded results without copying another agent runtime's hook system."
---
...
Use after meaningful code or config changes in agent runtime to run the smallest relevant verification set and report grounded results without copying another agent runtime's hook system.

## Use When

- The user request matches `agent-verification-gate`, `agent verification gate`, `software-development` or the skill description.
- Use after meaningful code or config changes in agent runtime to run the smallest relevant verification set and report grounded results without copying another agent runtime's hook system.
