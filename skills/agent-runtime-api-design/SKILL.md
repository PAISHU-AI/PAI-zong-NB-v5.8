---
name: agent-runtime-api-design
description: "Use when designing REST, GraphQL, RPC, webhook, or internal service interfaces in agent-runtime repository work."
---
...
Use when designing REST, GraphQL, RPC, webhook, or internal service interfaces in agent-runtime repository work.

## Use When

- The user request matches `agent-runtime-api-design`, `agent runtime api design`, `software-development` or the skill description.
- Use when designing REST, GraphQL, RPC, webhook, or internal service interfaces in agent-runtime repository work.
